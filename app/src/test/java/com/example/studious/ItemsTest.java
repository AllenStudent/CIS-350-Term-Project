...
public class ItemsTest {
    ...
    @Test
    public void getId() {
        Items t = new Items(0, "Test", 1, "test", "04/15/2022","04/16/2022");
    ...
    @Test
    public void setId() {
        Items t = new Items(1, "Test", 1, "test", "04/15/2022","04/16/2022");
    ...
    public void testToString() {
        Items t = new Items(5, "By", 5, "test", "04/15/2022","04/16/2022");
    ...
    public void testEquals() {
        Items s = new Items(5, "By", 5, "test", "04/15/2022","04/16/2022");
        Items t = new Items(5, "By", 5, "test", "04/15/2022","04/16/2022");
        assertEquals(s, t);
    }
    ...
    public void testNotEquals() {
        Items s = new Items(0, "By", 5, "test", "04/15/2022","04/16/2022");
        Items t = new Items(5, "a", 5, "test", "04/15/2022","04/16/2022");
        Items u = new Items(5, "By", 0, "test", "04/15/2022","04/16/2022");
        assertNotEquals(s, t);
        assertNotEquals(s, u);
    }
    ...
    public void testEqualsNull() {
        Items t = new Items(0, "By", 5, "test", "04/15/2022","04/16/2022");
